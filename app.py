        ...
        if df_diem_chuan is None or df_diem_chuan.empty:
            ...
            for col in df_working.columns:
                ...
                for kw in target_keywords:
                    # Fix tìm kiếm: Sử dụng word boundary \b cho từ khóa "ai" để tránh bị nhận dạng nhầm với "đại", "bài", "tài"...
                    if kw == "ai":
                        mask = mask | col_str.str.contains(r'\bai\b', regex=True, na=False)
                    else:
            ...
            if filtered_df.empty:
                ...
                # Ưu tiên các trường hợp match chính xác (cả từ) trước khi tìm trong substring
                ...
                # Fix: Thêm cột Tên Ngành (vì người dùng không biết đây là ngành gì nếu không hiển thị)
