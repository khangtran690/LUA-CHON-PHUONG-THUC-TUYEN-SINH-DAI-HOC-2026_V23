        ...
        with st.spinner(t["analysis_searching"]):
            ...
            if raw_data is None or raw_data.empty:
                ...
                for _, row in raw_data.iterrows():
                    search_str = " ".join([str(v) for v in row.values if pd.notna(v)])
                ...
                if matched_rows:
                    ...
                    # Gom nhóm để tổng hợp Phương thức xét tuyển & Lấy Điểm chuẩn chính xác
                    ...
                    grouped["Tên trường"] = grouped["Tên trường"].apply(clean_str)
                    grouped["Tên ngành"] = grouped["Tên ngành"].apply(clean_str)
                    grouped["Mã ngành"] = grouped["Mã ngành"].apply(clean_str)
