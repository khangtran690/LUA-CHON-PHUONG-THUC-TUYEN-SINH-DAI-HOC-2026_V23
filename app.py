...
# CSS tùy chỉnh giao diện và đường viền hiện đại
st.markdown(f"""
    <style>
    .copyright-header {{
        position: absolute;
...
# ---------------------------------------------------------
# PHÂN TÍCH & TƯ VẤN (CẬP NHẬT HOÀN THIỆN LỖI)
# ---------------------------------------------------------
st.markdown("---")
    ...
    with st.spinner(t["analysis_searching"]):
        ...
        if df_diem_chuan is None or df_diem_chuan.empty:
            ...
            if filtered_df.empty:
                ...
                # HTML custom table với CSS tối ưu hóa cho Streamlit
                html_table = """
                <style>
                    ...
                    .custom-analysis-table thead tr {
                    ...
                    .custom-analysis-table tbody tr:nth-of-type(even) {
                        background-color: rgba(248, 250, 252, 0.5);
                    }
                    .custom-analysis-table tbody tr:hover {
