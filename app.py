...
if btn_analyze:
    with st.spinner(t["analysis_searching"]):
        ...
        if df_diem_chuan is None or df_diem_chuan.empty:
            ...
            keywords_map = {
                "Trí tuệ nhân tạo (AI) trong kinh doanh": ["trí tuệ"],
                "Khoa học dữ liệu trong kinh doanh": ["Khoa học dữ liệu"],
                "Phân tích dữ liệu trong kinh doanh": ["Phân tích dữ liệu"],
                "Khoa học máy tính trong kinh doanh": ["Khoa học máy tính"]
            }
