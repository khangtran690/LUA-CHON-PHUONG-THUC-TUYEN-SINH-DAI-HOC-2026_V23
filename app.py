            ...
            if raw_data is None or raw_data.empty:
                ...
                if not matched_rows:
                    ...
                    for idx, r in enumerate(df_matched.iterrows(), 1):
                        row_data = r[1]
                        s_name = clean_str(row_data[col_school]) if col_school in df_matched.columns else "N/A"
                        m_name = clean_str(row_data[col_major]) if col_major in df_matched.columns else "N/A"
                        m_code = clean_str(row_data[col_code]) if col_code and col_code in df_matched.columns else "N/A"
                        ...
                        if col_method and col_method in df_matched.columns:
                            ptxt_val = clean_str(row_data[col_method])
                        else:
                            ptxt_val = "N/A"
                        ...
                        result_data.append({
                            ...
                            "Phương thức xét tuyển": ptxt_val
                        })
